...
H=/home/huagosr/wechat-linux-research/hub/data/workers/opencode/ex-7/home
K=$(cut -d= -f2 ~/.opencode/.env)
timeout 12 bwrap --unshare-user --unshare-ipc --unshare-pid --unshare-uts --unshare-cgroup \
  ...
  --die-with-parent -- /opt/opencode-bin/opencode serve --port 4567 --hostname 127.0.0.1 2>&1 | head -n 25
